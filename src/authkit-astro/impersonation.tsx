...
import { MinMaxButton } from "./min-max-button.jsx";

interface ImpersonationProps extends React.ComponentPropsWithoutRef<"div"> {
  side?: "top" | "bottom";
}

export async function Impersonation({
  side = "bottom",
  ...props
}: ImpersonationProps) {
      ...
      >
        ...
        >
          ...
          <Button
            ...
            style={{
              marginLeft: "calc(var(--wi-s) * 2)",
              marginRight: "var(--wi-s)",
            }}
          >
            Stop
          </Button>
          <MinMaxButton minimizedValue="1">
            {side === "top" ? "↗" : "↘"}
          </MinMaxButton>
        </form>
        ...
        <div
          style={{
            ...
            transition: "all 500ms cubic-bezier(0.16, 1, 0.3, 1)",
            transform:
              "translateX(calc((1 - var(--wi-minimized)) * var(--wi-s) * -5))",
